...
set_property PACKAGE_PIN U8 [get_ports {inicio_initialisation}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {inicio_initialisation}]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
set_property PACKAGE_PIN R7 [get_ports {inicio_READ}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {inicio_READ}]
##Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
set_property PACKAGE_PIN R6 [get_ports {inicio_WRITE}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {inicio_WRITE}]
##Bank = 34, Pin name = IO_L19N_T3_VREF_34,					Sch name = SW4
set_property PACKAGE_PIN R5 [get_ports {leer_dato}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {leer_dato}]
##Bank = 34, Pin name = IO_L20P_T3_34,						Sch name = SW5
set_property PACKAGE_PIN V7 [get_ports {dato_escribir[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dato_escribir[0]}]
##Bank = 34, Pin name = IO_L20N_T3_34,						Sch name = SW6
set_property PACKAGE_PIN V6 [get_ports {dato_escribir[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dato_escribir[1]}]
##Bank = 34, Pin name = IO_L10P_T1_34,						Sch name = SW7
set_property PACKAGE_PIN V5 [get_ports {dato_escribir[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dato_escribir[2]}]
##Bank = 34, Pin name = IO_L8P_T1-34,						Sch name = SW8
set_property PACKAGE_PIN U4 [get_ports {dato_escribir[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dato_escribir[3]}]
##Bank = 34, Pin name = IO_L9N_T1_DQS_34,					Sch name = SW9
set_property PACKAGE_PIN V2 [get_ports {dato_escribir[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dato_escribir[4]}]
##Bank = 34, Pin name = IO_L9P_T1_DQS_34,					Sch name = SW10
set_property PACKAGE_PIN U2 [get_ports {dato_escribir[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dato_escribir[5]}]
##Bank = 34, Pin name = IO_L11N_T1_MRCC_34,					Sch name = SW11
set_property PACKAGE_PIN T3 [get_ports {dato_escribir[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dato_escribir[6]}]
##Bank = 34, Pin name = IO_L17N_T2_34,						Sch name = SW12
set_property PACKAGE_PIN T1 [get_ports {dato_escribir[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dato_escribir[7]}]
...
set_property PACKAGE_PIN G14 [get_ports {dato_leer[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dato_leer[0]}]
##Bank = 14, Pin name = IO_L13P_T2_MRCC_14,					Sch name = JB2
set_property PACKAGE_PIN P15 [get_ports {dato_leer[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dato_leer[1]}]
##Bank = 14, Pin name = IO_L21N_T3_DQS_A06_D22_14,			Sch name = JB3
set_property PACKAGE_PIN V11 [get_ports {dato_leer[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dato_leer[2]}]
##Bank = CONFIG, Pin name = IO_L16P_T2_CSI_B_14,				Sch name = JB4
set_property PACKAGE_PIN V15 [get_ports {dato_leer[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dato_leer[3]}]
##Bank = 15, Pin name = IO_25_15,							Sch name = JB7
set_property PACKAGE_PIN K16 [get_ports {dato_leer[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dato_leer[4]}]
##Bank = CONFIG, Pin name = IO_L15P_T2_DQS_RWR_B_14,			Sch name = JB8
set_property PACKAGE_PIN R16 [get_ports {dato_leer[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dato_leer[5]}]
##Bank = 14, Pin name = IO_L24P_T3_A01_D17_14,				Sch name = JB9
set_property PACKAGE_PIN T9 [get_ports {dato_leer[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dato_leer[6]}]
##Bank = 14, Pin name = IO_L19N_T3_A09_D25_VREF_14,			Sch name = JB10 
set_property PACKAGE_PIN U11 [get_ports {dato_leer[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dato_leer[7]}]
 


##Pmod Header JC
##Bank = 35, Pin name = IO_L23P_T3_35,						Sch name = JC1
set_property PACKAGE_PIN K2 [get_ports {AD0_AD7[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AD0_AD7[0]}]
##Bank = 35, Pin name = IO_L6P_T0_35,						Sch name = JC2
set_property PACKAGE_PIN E7 [get_ports {AD0_AD7[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AD0_AD7[1]}]
##Bank = 35, Pin name = IO_L22P_T3_35,						Sch name = JC3
set_property PACKAGE_PIN J3 [get_ports {AD0_AD7[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AD0_AD7[2]}]
##Bank = 35, Pin name = IO_L21P_T3_DQS_35,					Sch name = JC4
set_property PACKAGE_PIN J4 [get_ports {AD0_AD7[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AD0_AD7[3]}]
##Bank = 35, Pin name = IO_L23N_T3_35,						Sch name = JC7
set_property PACKAGE_PIN K1 [get_ports {AD0_AD7[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AD0_AD7[4]}]
##Bank = 35, Pin name = IO_L5P_T0_AD13P_35,					Sch name = JC8
set_property PACKAGE_PIN E6 [get_ports {AD0_AD7[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AD0_AD7[5]}]
##Bank = 35, Pin name = IO_L22N_T3_35,						Sch name = JC9
set_property PACKAGE_PIN J2 [get_ports {AD0_AD7[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AD0_AD7[6]}]
##Bank = 35, Pin name = IO_L19P_T3_35,						Sch name = JC10
set_property PACKAGE_PIN G6 [get_ports {AD0_AD7[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AD0_AD7[7]}]
 

 
##Pmod Header JD
##Bank = 35, Pin name = IO_L21N_T2_DQS_35,					Sch name = JD1
set_property PACKAGE_PIN H4 [get_ports {CS}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {CS}]
##Bank = 35, Pin name = IO_L17P_T2_35,						Sch name = JD2
set_property PACKAGE_PIN H1 [get_ports {RD}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RD}]
##Bank = 35, Pin name = IO_L17N_T2_35,						Sch name = JD3
set_property PACKAGE_PIN G1 [get_ports {WR}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {WR}]
##Bank = 35, Pin name = IO_L20N_T3_35,						Sch name = JD4
set_property PACKAGE_PIN G3 [get_ports {AD}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AD}]
##Bank = 35, Pin name = IO_L15P_T2_DQS_35,					Sch name = JD7
#set_property PACKAGE_PIN H2 [get_ports {Data}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {Data}]
##Bank = 35, Pin name = IO_L20P_T3_35,						Sch name = JD8
set_property PACKAGE_PIN G4 [get_ports {end_flag_READ}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {end_flag_READ}]
##Bank = 35, Pin name = IO_L15N_T2_DQS_35,					Sch name = JD9
set_property PACKAGE_PIN G2 [get_ports {end_flag_WRITE}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {end_flag_WRITE}]
##Bank = 35, Pin name = IO_L13N_T2_MRCC_35,					Sch name = JD10
set_property PACKAGE_PIN F3 [get_ports {end_flag_Initialisation}]			
	set_property IOSTANDARD LVCMOS33 [get_ports {end_flag_Initialisation}]
